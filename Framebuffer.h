...
public:
    ...
    void printStringOnOLED(uint8_t pos_x, uint8_t pos_y, const char *str);
    void displayChar(char character, int x, int y);
...
const PROGMEM uint8_t FONT8X2[96][8][2] = {
    // ASCII 32 (' ')
    {
    ...
    // ASCII 34 ('"')
    {
        ...
        {0b00000000, 0b00000000},
        {0b00000000, 0b00000000}},
    // ... (Continue for characters A to Z)
    // ASCII 65 ('A')
    {
        {0b11110000, 0b10010000},
        {0b11111000, 0b10001000},
        {0b11110000, 0b10000000},
        {0b11111000, 0b10000000},
        {0b11111000, 0b10010000},
        {0b11110000, 0b10010000},
        {0b10011000, 0b11111000},
        {0b00000000, 0b00000000}},
    // ... (Continue for characters B to Z)
    // ASCII 90 ('Z')
    {
    ...
    // ASCII 97 ('a')
    {
        ...
        {0b00101100, 0b00111000},
        {0b00101010, 0b00101000},
        {0b00110010, 0b00101000},
        {0b00000000, 0b00000000}},
    // ... (Continue for characters 'b' to 'z')
    // ASCII 122 ('z')
    {
